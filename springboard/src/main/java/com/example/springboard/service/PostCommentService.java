...
public interface PostCommentService {
    ...
    // 작성
    PostCommentResponse create(Long memberId, Long postId, @Valid PostCommentCreateRequest request);

    // 수정
    PostCommentResponse update(Long memberId,Long commentId, @Valid PostCommentUpdateRequest request);
