...
public interface PostService {
    ...
    // RequestDTO -> Entity 변환, Repository.save()저장 -> 저장된 Entity -> Response DTO 저장
    ...
    // 게시글 상세 조회 + 조회수 증가
    @Nullable PostDetailResponse getPostDetail(Long id);
    // 게시글 수정1
    @Nullable PostDetailResponse updatePost(Long memberId,Long id, PostUpdateRequest request);
