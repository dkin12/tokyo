...
public class PostController {
    ...
    // 게시글 등록 ( 회원만 )
    @PostMapping
    @Operation(summary = "게시글 등록", description = "새로운 게시글 작성, 로그인 한 사람만 작성할 수 있습니다.")
    @ApiResponses({
    ...
    public ResponseEntity<PostDetailResponse> createPost(@io.swagger.v3.oas.annotations.parameters.RequestBody(
            description = "게시글 작성 요청 데이터", required = true, content = @Content(
